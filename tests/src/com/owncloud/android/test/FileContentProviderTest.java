package com.iluq_cloud.android.test;

import com.iluq_cloud.android.db.ProviderMeta.ProviderTableMeta;
import com.iluq_cloud.android.providers.FileContentProvider;
...
public class FileContentProviderTest extends ProviderTestCase2<FileContentProvider> {
	...
	public FileContentProviderTest() {
		super(FileContentProvider.class, "com.iluq_cloud.android.providers.FileContentProvider");
	}
